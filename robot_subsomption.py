...
class Robot_player(Robot):
    ...
    def step(self, sensors, sensor_view=None, sensor_robot=None, sensor_team=None):
        ...
        # Détection de mur
        # 0 = loin, 1 = proche mur/robot devant
        near_wall = max(1 - sensor_to_wall[sensor_front],
        ...
        near_robot = max(1 - sensor_to_robot[sensor_front],
        ...
        if near_wall > 0.6 :
            ...
            translation = (
                0.8 * sensor_to_wall[sensor_front] +
                0.5 * sensor_to_wall[sensor_front_left] +
        ...
        # love bot
            ...
            print("Subsomption : LOVE BOT")
            translation = (
                0.8 * sensor_to_robot[sensor_front] +
                0.5 * sensor_to_robot[sensor_front_left] +
                0.5 * sensor_to_robot[sensor_front_right] +
                0.3 * sensor_to_robot[sensor_left] +
                0.3 * sensor_to_robot[sensor_right]
                )
