...
class Robot_player(Robot):
    ...
    def step(self, sensors, sensor_view=None, sensor_robot=None, sensor_team=None):
        ...
        if self.robot_id == 0:
            ...
            rotation = 0.6*sensors[sensor_front_left] - 0.6*sensors[sensor_front_right] + 0.5*sensors[sensor_left] - 0.5*sensors[sensor_right] + (random.random() - 0.5)*0.1
        
        # robot 1 : braitenberg + subsomption (si trop longtemps sans avancer : forcer tourner)
        # elif self.robot_id == 1:
            
        
        # robot 2 : competement optimisé par randomSearch2
