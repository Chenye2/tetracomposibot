...
def initialize_robots(arena_size=-1, particle_box=-1): # particle_box: size of the robot enclosed in a square
    ...
    robots.append(genetic_algorithms.Robot_player(x_center, y_center, 0, name="Genetic Algorithms", team="D",evaluations=evaluations,it_per_evaluation=it_per_evaluation))
