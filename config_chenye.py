...
def initialize_robots(arena_size=-1, particle_box=-1): # particle_box: size of the robot enclosed in a square
    ...
    #robots.append(robot_wanderer.Robot_player(15, 30, 0, name="My Robot", team="B"))

    robots.append(robot_braitenberg_avoider.Robot_player(80, 40, 0, name="My Robot", team="C"))

    #robots.append(robot_braitenberg_loveWall.Robot_player(20, 30, -50, name="My Robot", team="D"))

    robots.append(robot_braitenberg_hateWall.Robot_player(20, 30, -50, name="My Robot", team="E"))
